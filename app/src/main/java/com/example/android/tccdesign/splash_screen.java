    ...
    public void VerificaLogin() {
        ...
        if (rm != null) {
            if (isOnline(getApplicationContext()) == false) {
                ...
                sala = prefs.getString("Sala", "");
                curso = prefs.getString("Curso", "");
                numero = prefs.getString("Número", "");
                validade = prefs.getString("Validade", "");

                try {
                    jsonObject = new JSONObject(prefs.getString("jsonNotas", ""));
                    jsonArray = jsonObject.getJSONArray("Notas");
                    ...
                    bundle.putString("Número", numero);
